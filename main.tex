...
\logo{./resources/pdf/isp_logo.png}
\institute{Universit\"at de Val\`encia}
\faculty{Image and Signal Processing Laboratory}
%\department{Department of Anything but Psychology}
\title{A Math Notation \LaTeX{} Template}
...
\begin{document}
    ...
    \include{sections/prob}
    \include{sections/info_theory}
