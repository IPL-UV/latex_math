...
## Inspiration: Sleek Template

This was inspired by the [sleek template](https://github.com/francois-rozet/sleek-template/archive/overleaf.zip) by [François Rozet](https://github.com/francois-rozet)
